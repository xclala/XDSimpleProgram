try:
    ...
    class MainDemo(QMainWindow):
        def __init__(self, *args, **kwargs):
            ...
            new_tab_action = QAction(QIcon('icons/add_page.png'), 'New Page',
                                     self)
            ...
            forward_button = QAction(QIcon('icons/forward.png'), 'Forward',
                                     self)
        ...
        def add_new_tab(self, qurl=QUrl(''), label='Blank'):
            ...
            self.browser.urlChanged.connect(
                lambda qurl, browser=self.browser: self.renew_urlbar(
                    qurl, self.browser))
            # 将标签标题改为网页相关的标题
            self.browser.loadFinished.connect(
                lambda _, i=i, browser=self.browser: self.tabs.setTabText(
                    i,
